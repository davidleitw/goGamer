...
---
**寫此專案的時候還沒有熟悉 goroutine 的一些用法，所以有很多需要改進的部份，預計之後會找時間重構。**


用go語言開發的巴哈姆特API, 未來的開發方向可能會以查詢類為主(檢索特定文章, 或者特定帳號的發文)
有空的會也會簡單描述一下爬蟲的概念以及go語言實作爬蟲以及包裝API的介紹
開發上面選擇goquery爬蟲 + gin製作API, 最後部屬到Heroku上面供大家使用

另外也要感謝好夥伴 **@FizzyEit** 的貢獻, 不只參與的API的協作, 也製作了一些功能簡易的前端, 以便於一般使用者的運用
[goGamer](https://go-gamer.herokuapp.com/searchUser)

![](https://imgur.com/Oj0QtU9.png)
